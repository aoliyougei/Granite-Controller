...
func TestValidateToolCall(t *testing.T) {
	tests := []struct {
		...
		{"关掉 VM 3052", "pve_vm_shutdown", `{"vmid":3052}`, false, ActionShutdown, ""},
		{"关闭 VM 3052", "pve_vm_shutdown", `{"vmid":3052}`, false, ActionShutdown, ""},
		{"VM 3052 关机", "pve_vm_shutdown", `{"vmid":3052}`, false, ActionShutdown, ""},
		{"强制关机 VM 3052", "pve_vm_shutdown", `{"vmid":3052}`, true, "", "ambiguous_managed_command"},
